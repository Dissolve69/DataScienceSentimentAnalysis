...
class Negativewords(models.Model):
    num = models.AutoField(primary_key=True, blank=True, null=True)
    words = models.TextField(unique=True, blank=True, null=True)
...
class Scraping(models.Model):
    ...
    links = models.TextField(unique=True, blank=True, null=True)
